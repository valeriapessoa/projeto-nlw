...
export function CreateAdModal() {
    ...
    async function handleCreateAd(event: FormEvent) {
        event.preventDefault();   //Previne de não mudar de página ao enviar o formulário

        const  formaData = new FormData(event.target as HTMLFormElement)   //O target pode ser qualquer coisa, então temos que informar que é um formulário de HTML
